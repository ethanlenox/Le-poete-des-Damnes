...
const Progress = {
  ...
  if(current && !isNaN(a.currentTime)){
    current.textContent = this.formatTime(a.currentTime || 0);
  }

  if(duration && !isNaN(a.duration)){
    duration.textContent = this.formatTime(a.duration || 0);
  }
}
